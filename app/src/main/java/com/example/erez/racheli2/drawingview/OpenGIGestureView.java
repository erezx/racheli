package com.example.erez.racheli2.drawingview;
...
/**
 * Created by Erez on 1/19/2017.
 */
public class OpenGIGestureView extends GLSurfaceView {
    ...
    public OpenGIGestureView(Context context, AttributeSet attrs) {
        super(context, attrs);
